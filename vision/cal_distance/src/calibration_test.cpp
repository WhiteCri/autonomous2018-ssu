...
public:
    ...
    Pos pixel_to_real(const Pos& pos){
      ...
      cout<<"idx.x : "<<idx.x <<" / idx.y : "<<idx.y<<endl;
...
int main(int argc, char** argv){
    ...
    if(IMAGE){
      ...
      while(1){
        cout<<"!!"<<endl;
        src = imread("/home/kite9240/catautonomous_ws/src/autonomous2018-ssu/vision/cal_distance/src/right_1m.png", CV_LOAD_IMAGE_COLOR);

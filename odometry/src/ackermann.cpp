...
#define PI 3.141592
#define IGNORE_STEER 0.1 // IGNORE_STEER 이하의 각도[deg]에서는 직진으로 odometry 계산(singularity point 때문에)
                         ...
                         const ros::Time& time)
{
    ...
    steering_ = PlatformRX_data->steer;

    nh_.getParam("wheelbase_", wheelbase_);

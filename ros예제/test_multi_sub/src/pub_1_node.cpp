...
{
  ros::init(argc, argv, "topic_publisher_1");     // Initializes Node Name
  ...
  ros::Publisher ros_tutorial_pub = nh.advertise<test_multi_sub::message_1>("Topic_1", 100);

  // Set the loop period. '10' refers to 10 Hz and the main loop repeats at 0.1 second intervals
  ros::Rate loop_rate(10);

  test_multi_sub::message_1 msg;     // Declares message 'msg' in 'MsgTutorial' message file format

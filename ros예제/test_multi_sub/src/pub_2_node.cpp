...
#include "test_multi_sub/message_2.h"    // MsgTutorial Message File Header. The header file is automatically created when building the package.

int main(int argc, char **argv)                 // Node Main Function
{
  ros::init(argc, argv, "topic_publisher_2");     // Initializes Node Name
  ...
  ros::Publisher ros_tutorial_pub = nh.advertise<test_multi_sub::message_2>("Topic_2", 100);

  // Set the loop period. '10' refers to 10 Hz and the main loop repeats at 0.1 second intervals
  ros::Rate loop_rate(10);

  test_multi_sub::message_2 msg;     // Declares message 'msg' in 'MsgTutorial' message file format
